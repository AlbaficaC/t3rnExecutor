...
function execute_script() {
    ...
    # 下载文件
    echo "正在下载 executor-linux-v0.38.0.tar.gz..."
    ...
    # 提示用户输入环境变量的值，给 EXECUTOR_MAX_L3_GAS_PRICE 设置默认值为 10
    read -p "请输入 EXECUTOR_MAX_L3_GAS_PRICE 的值 [默认 10]: " EXECUTOR_MAX_L3_GAS_PRICE
    EXECUTOR_MAX_L3_GAS_PRICE="${EXECUTOR_MAX_L3_GAS_PRICE:-10}"

    # 提示用户输入 RPC_ENDPOINTS_OPSP，如果没有输入则使用默认值
    read -p "请输入 RPC_ENDPOINTS_OPSP 的值 [默认 https://opt-sepolia.g.alchemy.com/v2/Bc0YNI2hVeNWPm-3Cnc6if5kuhhOSK6x]: " RPC_ENDPOINTS_OPSP
    RPC_ENDPOINTS_OPSP="${RPC_ENDPOINTS_OPSP:-https://opt-sepolia.g.alchemy.com/v2/Bc0YNI2hVeNWPm-3Cnc6if5kuhhOSK6x}"

    # 提示用户输入 RPC_ENDPOINTS_BSSP，如果没有输入则使用默认值
    read -p "请输入 RPC_ENDPOINTS_BSSP 的值 [默认 https://base-sepolia.g.alchemy.com/v2/Bc0YNI2hVeNWPm-3Cnc6if5kuhhOSK6x]: " RPC_ENDPOINTS_BSSP
    RPC_ENDPOINTS_BSSP="${RPC_ENDPOINTS_BSSP:-https://base-sepolia.g.alchemy.com/v2/Bc0YNI2hVeNWPm-3Cnc6if5kuhhOSK6x}"

    # 提示用户输入 RPC_ENDPOINTS_BLSS，如果没有输入则使用默认值
    read -p "请输入 RPC_ENDPOINTS_BLSS 的值 [默认 https://blast-sepolia.g.alchemy.com/v2/Bc0YNI2hVeNWPm-3Cnc6if5kuhhOSK6x]: " RPC_ENDPOINTS_BLSS
    RPC_ENDPOINTS_BLSS="${RPC_ENDPOINTS_BLSS:-https://blast-sepolia.g.alchemy.com/v2/Bc0YNI2hVeNWPm-3Cnc6if5kuhhOSK6x}"

    # 提示用户输入 RPC_ENDPOINTS_ARBT，如果没有输入则使用默认值
    read -p "请输入 RPC_ENDPOINTS_ARBT 的值 [默认 https://arb-sepolia.g.alchemy.com/v2/Bc0YNI2hVeNWPm-3Cnc6if5kuhhOSK6x]: " RPC_ENDPOINTS_ARBT
    RPC_ENDPOINTS_ARBT="${RPC_ENDPOINTS_ARBT:-https://arb-sepolia.g.alchemy.com/v2/Bc0YNI2hVeNWPm-3Cnc6if5kuhhOSK6x}"
